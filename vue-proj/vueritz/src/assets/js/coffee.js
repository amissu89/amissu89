export default [
    {
        ...
        description: [
            "국가 : 콜롬비아 Colombia",
            "지역 : 우일라 Huila",
            "농장 : Coffee Producers from Huila",
            "가공방식 : 디카페인 Decaffeinated",
        ],
        description2: [
    ...
    },
    {
        ...
        description: [
            "국가: 코스타리카 Costa Rica",
            "지역: 타라수 Tarrazú",
            "농장: 라 크루스 데 타라수 La Cruz de Tarrazú",
            "농부: 에스테반 사모라 Esteban Zamora",
            "품종: 카투라-카투아이 Caturra-Catuaí",
            "가공방식: 블랙 허니 Black Honey (El Cedro)",
        ],
        description2: [
